...
/* harmony import */ var _gaurd_auth_guard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./gaurd/auth.guard */ "./src/app/gaurd/auth.guard.ts");
...
const routes = [
    ...
    { path: 'register', component: _register_register_component__WEBPACK_IMPORTED_MODULE_4__["RegisterComponent"], canActivate: [_gaurd_auth_guard__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]] },
    { path: 'dashboard', component: _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_3__["DashboardComponent"], canActivate: [_gaurd_auth_guard__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]] },
];
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [ngx_cookie_service__WEBPACK_IMPORTED_MODULE_9__["CookieService"]], imports: [[
...
function DashboardComponent_nav_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_nav_0_Template_a_click_7_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r6.logout(); });
...
function DashboardComponent_h1_5_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h1");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Client List");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function DashboardComponent_h1_6_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h1");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "User List");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function DashboardComponent_button_8_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 18);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Add New Client");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function DashboardComponent_button_9_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 18);
...
function DashboardComponent_tr_23_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_tr_23_Template_button_click_10_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11); const item_r8 = ctx.$implicit; const ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r10.resetPassword(item_r8); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](11, "Edit");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](12, "button", 19);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_tr_23_Template_button_click_12_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11); const i_r9 = ctx.index; const ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r12.deleteUser(i_r9); });
...
class DashboardComponent {
    constructor(loginService, cookieService, router, dataService) {
    ...
    ngOnInit() {
        if (this.cookieService.get('userType') === 'admin') {
            this.userType = true;
            this.loginService.getAllClientList().subscribe((response) => {
                if (response != null) {
            ...
            if (this.cookieService.get('domainName') != null) {
                ...
                this.loginService.getUserListByClient(this.user).subscribe((response) => {
                    if (response != null) {
                        this.userList = response;
                    }
                    else {
    ...
    deleteUser(index) {
        ...
        if (this.cookieService.get('userType') === 'admin') {
            this.loginService.deleteClientUser(this.userId).subscribe((response) => {
            ...
            this.loginService.deleteUser(this.userId).subscribe((response) => {
                if (response != null && response.result === 'success') {
                    const data = this.userList;
                    data.splice(index, 1);
                    this.userList = data;
...
DashboardComponent.ɵfac = function DashboardComponent_Factory(t) { return new (t || DashboardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_cookie_service__WEBPACK_IMPORTED_MODULE_3__["CookieService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_data_service__WEBPACK_IMPORTED_MODULE_5__["DataService"])); };
DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DashboardComponent, selectors: [["app-dashboard"]], decls: 24, vars: 6, consts: [["class", "navbar navbar-expand navbar-light bg-light", 4, "ngIf"], [1, "container"], [1, "row"], [1, "col-9"], [4, "ngIf"], [1, "col-3", "float-right"], ["type", "button", "class", "btn btn-dark", "routerLink", "/register", 4, "ngIf"], [1, "table", "table-hover"], [1, "thead-dark"], [4, "ngFor", "ngForOf"], [1, "navbar", "navbar-expand", "navbar-light", "bg-light"], [1, "navbar-nav"], ["routerLink", "/dashboard", 1, "nav-item", "nav-link"], ["src", "../../assets/images/logo.png", "alt", ""], ["id", "navbarNav", 1, "collapse", "navbar-collapse"], [1, "nav", "navbar-nav", "ml-auto"], [1, "nav-item", "active"], [1, "nav-item", "nav-link", "ml-auto", "logout", 3, "click"], ["type", "button", "routerLink", "/register", 1, "btn", "btn-dark"], ["type", "button", 1, "btn", "btn-dark", "mr-2", 3, "click"]], template: function DashboardComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DashboardComponent, [{
    ...
    }], function () { return [{ type: _user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"] }, { type: ngx_cookie_service__WEBPACK_IMPORTED_MODULE_3__["CookieService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }, { type: _data_service__WEBPACK_IMPORTED_MODULE_5__["DataService"] }]; }, null); })();
...
let DataService = class DataService {
    ...
    get sharedData() { return this.data; }
    set edit(name) {
        this.isEedit = name;
    }
    get edit() { return this.isEedit; }
};
...
class LoginComponent {
    constructor(loginService, route, cookieService, router) {
        this.loginService = loginService;
        this.route = route;
        this.cookieService = cookieService;
        this.router = router;
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 25, vars: 5, consts: [[1, "container", "py-5"], [1, "row"], [1, "col-md-10", "mx-auto"], [1, "", 3, "formGroup"], [1, "form-group", "row"], ["src", "../../assets/images/logo.png", "alt", ""], ["class", "col-6 alert alert-danger mb-3", 4, "ngIf"], [1, "col-6"], [1, "lb-lg", "text-dark"], ["type", "text", "id", "inputFirstname", "placeholder", "User Name", "formControlName", "userName", "required", "", 1, "form-control"], [1, "col-4"], ["class", "alert alert-danger mt-4", 4, "ngIf"], ["type", "password", "id", "exampleInputPassword1", "placeholder", "Password", "formControlName", "password", "required", "", 1, "form-control", 3, "keyup.enter"], [1, "col-3"], ["type", "button", "id", "loginId", 1, "btn", "btn-dark", "btn-block", 3, "disabled", "click"], [1, "col-6", "alert", "alert-danger", "mb-3"], [1, "alert", "alert-danger", "mt-4"], [4, "ngIf"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup.enter", function LoginComponent_Template_input_keyup_enter_18_listener($event) { return ctx.loginEnter($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_button_click_23_listener() { return ctx.userLogin(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginComponent, [{
    ...
    }], function () { return [{ type: _user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }, { type: ngx_cookie_service__WEBPACK_IMPORTED_MODULE_4__["CookieService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }]; }, null); })();
...
function RegisterComponent_nav_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterComponent_nav_0_Template_a_click_7_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.logout(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](8, "Logout");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
function RegisterComponent_div_27_div_7_div_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " DomainName is required. ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function RegisterComponent_div_27_div_7_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 27);
...
class RegisterComponent {
    constructor(loginService, route, cookieService, router, dataService) {
        this.loginService = loginService;
        this.route = route;
        this.cookieService = cookieService;
        this.router = router;
    ...
    ngOnInit() {
        ...
        this.registationForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
            ...
            domainName: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', [
                _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required,
            ]),
        });
        if (!this.userType) {
...
RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RegisterComponent, selectors: [["app-register"]], decls: 35, vars: 7, consts: [["class", "navbar navbar-expand navbar-light bg-light", 4, "ngIf"], [1, "container"], [1, "", 3, "formGroup"], [1, "row"], [1, "col-6", "mb-3", "input-group"], [1, "input-group-prepend"], ["id", "inputGroup-sizing-default", 1, "input-group-text"], ["type", "text", "formControlName", "userName", "aria-label", "Sizing example input", "aria-describedby", "inputGroup-sizing-default", 1, "form-control"], [1, "col-4"], ["class", "alert alert-danger mt-1", 4, "ngIf"], ["type", "password", "formControlName", "password", "aria-label", "Sizing example input", "aria-describedby", "inputGroup-sizing-default", 1, "form-control"], ["class", "alert alert-danger", 4, "ngIf"], ["type", "text", "formControlName", "email", "aria-label", "Sizing example input", "aria-describedby", "inputGroup-sizing-default", 1, "form-control"], ["class", "row", 4, "ngIf"], [1, "col-3"], ["type", "button", 1, "btn", "btn-dark", "btn-block", 3, "disabled", "click"], ["type", "button", 1, "btn", "btn-dark", "btn-block", 3, "click"], [1, "navbar", "navbar-expand", "navbar-light", "bg-light"], [1, "navbar-nav"], ["routerLink", "/dashboard", 1, "nav-item", "nav-link"], ["src", "../../assets/images/logo.png", "alt", ""], ["id", "navbarNav", 1, "collapse", "navbar-collapse"], [1, "nav", "navbar-nav", "ml-auto"], [1, "nav-item", "active"], [1, "nav-item", "nav-link", "ml-auto", "logout", 3, "click"], [1, "alert", "alert-danger", "mt-1"], [4, "ngIf"], [1, "alert", "alert-danger"], ["type", "text", "formControlName", "domainName", "aria-label", "Sizing example input", "aria-describedby", "inputGroup-sizing-default", 1, "form-control"]], template: function RegisterComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterComponent_Template_button_click_30_listener() { return ctx.saveUser(); });
...
module.exports = __webpack_require__(/*! D:\R_AND_D\Prasody\capv\ui\src\main.ts */"./src/main.ts");
